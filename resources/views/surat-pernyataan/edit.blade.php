...
<div class="header-page">
    <h1><i class="bi bi-pencil-square"></i> Edit Surat Pernyataan</h1>
    <p class="text-muted">Perbarui data surat pernyataan Anda</p>
</div>
    ...
    <div class="col-lg-8">
        <div class="card h-100">
            <div class="card-body p-5">
                <form method="POST" action="{{ route('surat-pernyataan.update', $permohonan) }}" enctype="multipart/form-data" id="suratPernyataanForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror" 
                            id="pekerjaan" name="pekerjaan" value="{{ old('pekerjaan', $suratPernyataan->pekerjaan) }}" required>
                        @error('pekerjaan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('no_ktp') is-invalid @enderror" 
                            id="no_ktp" name="no_ktp" value="{{ old('no_ktp', $suratPernyataan->no_ktp) }}" required>
                        @error('no_ktp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4 p-4" style="background-color: #f8f9fa; border-left: 4px solid #1a5490; border-radius: 4px;">
                        <div class="form-check mb-3">
                            <input class="form-check-input @error('setuju_syarat_1') is-invalid @enderror" type="checkbox" 
                                ...
                                {{ old('setuju_syarat_1', $suratPernyataan->setuju_syarat_1) ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input @error('setuju_syarat_2') is-invalid @enderror" type="checkbox" 
                                ...
                                {{ old('setuju_syarat_2', $suratPernyataan->setuju_syarat_2) ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input @error('setuju_syarat_3') is-invalid @enderror" type="checkbox" 
                                ...
                                {{ old('setuju_syarat_3', $suratPernyataan->setuju_syarat_3) ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input @error('setuju_syarat_4') is-invalid @enderror" type="checkbox" 
                                ...
                                {{ old('setuju_syarat_4', $suratPernyataan->setuju_syarat_4) ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input @error('setuju_syarat_5') is-invalid @enderror" type="checkbox" 
                                ...
                                {{ old('setuju_syarat_5', $suratPernyataan->setuju_syarat_5) ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input @error('setuju_syarat_6') is-invalid @enderror" type="checkbox" 
                                ...
                                {{ old('setuju_syarat_6', $suratPernyataan->setuju_syarat_6) ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input @error('setuju_syarat_7') is-invalid @enderror" type="checkbox" 
                                ...
                                {{ old('setuju_syarat_7', $suratPernyataan->setuju_syarat_7) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input @error('setuju_syarat_8') is-invalid @enderror" type="checkbox" 
                                ...
                                {{ old('setuju_syarat_8', $suratPernyataan->setuju_syarat_8) ? 'checked' : '' }}>
