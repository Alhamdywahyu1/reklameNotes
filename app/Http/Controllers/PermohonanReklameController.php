...
class PermohonanReklameController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $defaultDocuments = [
            ['jenis' => 'Fotocopy KTP berwarna', 'desc' => 'Fotocopy KTP pemohon yang masih berlaku'],
            ['jenis' => 'Fotocopy NPWP berwarna', 'desc' => 'Fotocopy NPWP pemohon'],
            ['jenis' => 'Fotocopy Akta Pendirian', 'desc' => 'Akta pendirian perusahaan atau badan usaha'],
            ['jenis' => 'Fotocopy Retribusi Pajak Reklame', 'desc' => 'Bukti pembayaran retribusi pajak reklame'],
            ['jenis' => 'Data Isian Pemohon', 'desc' => 'Formulir data isian pemohon yang telah diisi lengkap'],
            ['jenis' => 'Surat Pernyataan Pertanggungjawaban Konstruksi', 'desc' => 'Surat pernyataan dari pemilik/kuasa tentang konstruksi'],
            ['jenis' => 'Foto kondisi & visualisasi reklame', 'desc' => 'Dokumentasi foto kondisi lokasi dan desain reklame'],
            ['jenis' => 'Gambar konstruksi bidang', 'desc' => 'Gambar teknis konstruksi bidang reklame'],
            ['jenis' => 'Surat Kuasa', 'desc' => 'Surat kuasa jika permohonan diwakilkan (opsional)'],
        ];
        ...
        return redirect()->route('permohonan.show', $permohonan)
            ->with('success', 'Permohonan berhasil dibuat dengan nomor: ' . $permohonan->nomor_registrasi);
    }
